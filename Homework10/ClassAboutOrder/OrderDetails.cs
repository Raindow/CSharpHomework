...
namespace ClassAboutOrder
{
    ...
    public class OrderDetails
    {
        ...
        public bool addGoods(Good good)
        {
            if (orderThings.Count == 0 || (orderThings.Where(originalGood => originalGood.Name == good.Name).Count()) == 0) {
                good.Id = (uint)orderThings.Count + 1;
                orderThings.Add(good);
