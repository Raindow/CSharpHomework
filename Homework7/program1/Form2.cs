    ...
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try {
                ...
                DialogResult result = MessageBox.Show(ex.Message + "you have input" + this.textBox1.Text + "\nthis order has existed", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            finally {
                this.textBox1.Text = "";
            }
